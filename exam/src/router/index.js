  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/rankIng',//最近一次成绩排名
          component: () => import('@/components/teacher/rankIng')
        },
        {
        ...
        {
          path: '/correctIng', //未批改的简答题
          component: () => import('@/components/teacher/correctIng')
        },
        {
          path: '/correctEd',  //已经批改的简答题
          component: () => import('@/components/teacher/correctEd')
        }
      ]
    },
    {
