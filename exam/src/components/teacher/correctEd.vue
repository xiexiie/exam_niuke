    ...
    <el-table :data="pagination.records" border>
      ...
      <el-table-column fixed="right" label="操作" width="150">
        <template slot-scope="scope">
          <el-button @click="checkShortAnswer(scope.row.questionId)" type="primary" size="small">修改</el-button>
...
<script>
  export default {
    ...
    methods: {
      getStudentInfo() {
        //分页查询所有试卷信息
        this.$axios(`/api/shortAnswer1/${this.pagination.current}/${this.pagination.size}`).then(res => {
