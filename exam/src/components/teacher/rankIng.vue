...
<!--  table表格-->
  <div class="all">
    <div class="ranking" style="text-align: center">试卷名称</div>
    <el-table :data="pagination.records" border>
      ...
      <el-table-column prop="score" label="考试成绩" width="120"></el-table-column>
      <el-table-column prop="rank" label="排名" width="120"></el-table-column>
    </el-table>
    <el-pagination
